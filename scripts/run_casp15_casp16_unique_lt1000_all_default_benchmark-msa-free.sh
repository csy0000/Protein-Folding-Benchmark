...
RESULTS_DIR="${RESULTS_DIR:-results/$(date +%Y%m%d_%H%M%S)_casp15_casp16_unique_lt1000_all_default_msa-free}"
INCLUDE_STATUS="${INCLUDE_STATUS:-All}"
MODELS="${MODELS:-chai1,esmfold,omegafold}" # af2,colabfold,openfold
